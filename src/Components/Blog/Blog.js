...
const Blog = () => {
  return (
    <div className="blog">
      ...
      <div>
        <div className="qna">
          <p className="question text-white">What is CORS?</p>
          <p className="answer">
        ...
        <div className="qna">
          <p className="question text-white">Why do you use Firebase? What would be the Alternative of FireBase?</p>
          <p className="answer">
          ...
          <br/> <br />
          <strong> Alternative of Firebase :</strong> Parse, AWS AppSync, Firebase Cloud Messaging, MySQL, and Redis are the most popular alternatives and competitors to Firebase Realtime Database.
          </p>
        </div>
        <div className="qna">
          <p className="question text-white">How Does Private Router Work</p>
          <p className="answer">
        ...
        <div className="qna">
          <p className="question text-white">What is Node? How Does It Work?</p>
          <p className="answer">
